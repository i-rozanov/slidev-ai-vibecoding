...
<span>Генерация токенов последовательня</span>
...
<span>пример с жили у бабуси два весёлых гу-ся/ка/ля/ба</span>

---

# Как работает LLM

<span>Схема с 3-им токеном</span>

---

# Промежуточные выводы

<span>Инфа про то, как думает ллм, про "умность"</span>
