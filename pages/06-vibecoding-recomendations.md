...
<!--
Есть замечательная ссылка, которую нашёл в процессе подготовки, в которой собраны все лучшие практики, советую заглянуть, а если кратко: Выберите маленькую задачу, дайте весь необходимый контекст заранее, покажите, что хотите достичь, можете дать пример того, что должно получиться.
-->
...
<!--
Также закинул основные тренды, многие мы уже проговорили, такие как spec-first подход, где вы сначала создаете файл спецификации, куда закидываете всю необходимую информацию для реализации задачи.
Ещё хочу отметить вопросы безопасности, помимо подключений к реальным базам данных, учтите, что права на код скорее всего принадлежат не вам и решение об использовании удаленных провайдеров LLM принимать не вам.
...
<!--
Как я уже и сказал, пока что всё движется к тому, чтобы разработчики вырабатывали стратегию решения задачи, а саму рутину выполнял агент
-->
...
<!--
Примерно так программисты видят будущее за нейросетями без фантазий о том, что "нас всех заменят роботы". Планируется подключать ИИ там, где это действительно возможно, и реализуемо упрощение и ускорение, а также в местах, где важна выдача сжатой информации.
